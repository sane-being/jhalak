...
class FollowRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create follow_request" do
    assert_difference("FollowRequest.count") do
      post follow_requests_url, params: { follow_request: { accepted: @follow_request.accepted, follower_id: @follow_request.follower_id, user_id: @follow_request.user_id } }
    end
  ...
  test "should update follow_request" do
    patch follow_request_url(@follow_request), params: { follow_request: { accepted: @follow_request.accepted, follower_id: @follow_request.follower_id, user_id: @follow_request.user_id } }
